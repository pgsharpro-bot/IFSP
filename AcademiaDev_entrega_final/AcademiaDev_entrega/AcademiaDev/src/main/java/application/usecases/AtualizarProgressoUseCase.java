...
public class AtualizarProgressoUseCase {
    ...
    public void execute(String studentId, String enrollmentId, int newProgress) {
        ...
        Enrollment enrollment = enrollments.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new BusinessException("Matrícula ativa não encontrada para este aluno."));
